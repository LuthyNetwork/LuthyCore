package com.yan.minecraft.luthycore.libs.inventory;

import com.yan.minecraft.luthycore.LuthyAPI;
import com.yan.minecraft.luthycore.LuthyCore;
import com.yan.minecraft.luthycore.libs.inventory.content.InventoryContents;
import com.yan.minecraft.luthycore.libs.inventory.content.InventoryProvider;
import com.yan.minecraft.luthycore.libs.inventory.opener.InventoryOpener;
...
public class SmartInventory {
    ...
    public static final class Builder {
        ...
        public SmartInventory build() {
            ...
            InventoryManager manager = this.manager != null ? this.manager : LuthyCore.getApi().getInventoryManager();
